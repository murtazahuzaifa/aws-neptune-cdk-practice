...
export class Step00_Neptune_Lambda_Stack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const sg1 = new ec2.SecurityGroup(this, "graphDBSecurityGroup1", {
      vpc,
      allowAllOutbound: true,
      description: "security group 1",
      securityGroupName: "graphDBSecurityGroup",
    });
    cdk.Tags.of(sg1).add("Name", "graphDBSecurityGroup");
    ...
    const neptuneSubnet = new neptune.CfnDBSubnetGroup(
      ...
      "graphDBsubnetgroup",
      {
        dbSubnetGroupDescription: "GraphDB Subnet",
        subnetIds: vpc.selectSubnets({ subnetType: ec2.SubnetType.ISOLATED })
          .subnetIds,
        dbSubnetGroupName: "graphdbsubnetgroup",
      }
    );

    // Creating neptune cluster
    const neptuneCluster = new neptune.CfnDBCluster(this, "graphDBCluster", {
    ...
    const neptuneInstance = new neptune.CfnDBInstance(this, "graphDBinstance", {
